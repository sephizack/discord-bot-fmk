...
namespace DemoUserBotNs {
	export class DemoUserBot extends BaseDiscordUserBot {
		public constructor(name: string, discord: any, config: any) {
			super(name, discord, config)
			Logger.info(this.name, "created !")
			Logger.info(this.name, "Config data", this.config)
